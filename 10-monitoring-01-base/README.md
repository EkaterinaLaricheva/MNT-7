...
выведите в мониторинг и почему? 
 - Величина трафика - поможет оценить проблемы с сетью
 - Утилизация (нагрузка на CPU, память и др) - достаточно ли используемых ресурсов
 - Ошибки - на сколько стабильно работает приложение
...
Предложила бы использовать метрики SLO/SLA/SLI
...
ELK – это аббревиатура, используемая для описания стека из трех популярных проектов: Elasticsearch, Logstash и Kibana
