...
Можно вывести показатели на мониторинг, например Zabbix. Показатели взять из пункта 1. Например на одном дашборде мы мониттрим нагрузку на ЦПУ и процент занятой оперативной памяти. На второем дашборде пингуем интерфейс и смотри загрузку канала и проходение пакетов. Указать на мониторинге критичные значения. При нормальной визуализации и менеджеру станет понятно.
